...
module riscv_sim();
    ...
    initial begin
        $display("\n====================================================");
        $display("  TESTBENCH START: t14_add_negative");
        $display("  Instruction ROM: ../hex/t14_add_negative.hex");
        $display("====================================================\n");
        ...
        $readmemh("../hex/t14_add_negative.hex", U_RISCV.U_IM.memory);
