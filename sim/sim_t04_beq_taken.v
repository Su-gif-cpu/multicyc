...
module riscv_sim();
    ...
    initial begin
        $display("\n====================================================");
        $display("  TESTBENCH START: t04_beq_taken");
        $display("  Instruction ROM: ../hex/t04_beq_taken.hex");
        $display("====================================================\n");
        ...
        $readmemh("../hex/t04_beq_taken.hex", U_RISCV.U_IM.memory);
