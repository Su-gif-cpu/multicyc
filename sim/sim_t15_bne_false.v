...
module riscv_sim();
    ...
    initial begin
        $display("\n====================================================");
        $display("  TESTBENCH START: t15_bne_false");
        $display("  Instruction ROM: ../hex/t15_bne_false.hex");
        $display("====================================================\n");
        ...
        $readmemh("../hex/t15_bne_false.hex", U_RISCV.U_IM.memory);
