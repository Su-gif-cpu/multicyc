...
module riscv_sim();
    ...
    initial begin
        $display("\n====================================================");
        $display("  TESTBENCH START: t07_jal_link");
        $display("  Instruction ROM: ../hex/t07_jal_link.hex");
        $display("====================================================\n");
        ...
        $readmemh("../hex/t07_jal_link.hex", U_RISCV.U_IM.memory);
