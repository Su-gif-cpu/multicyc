...
module riscv_sim();
    ...
    initial begin
        $display("\n====================================================");
        $display("  TESTBENCH START: t10_loop_bne");
        $display("  Instruction ROM: ../hex/t10_loop_bne.hex");
        $display("====================================================\n");
        ...
        $readmemh("../hex/t10_loop_bne.hex", U_RISCV.U_IM.memory);
