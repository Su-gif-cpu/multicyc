...
module riscv_sim();
    ...
    initial begin
        $display("\n====================================================");
        $display("  TESTBENCH START: t05_beq_not_taken");
        $display("  Instruction ROM: ../hex/t05_beq_not_taken.hex");
        $display("====================================================\n");
        ...
        $readmemh("../hex/t05_beq_not_taken.hex", U_RISCV.U_IM.memory);
    ...
    always @(posedge clk) begin
        if (!rst) begin
            ...
            if (stable_pc_cycles >= 2 && U_RISCV.out_ins == 32'h0000006f) begin
                $display("\n==================== TEST PASS ====================");
                $display("  Test      : t05_beq_not_taken");
