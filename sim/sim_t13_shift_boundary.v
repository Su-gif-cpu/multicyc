...
module riscv_sim();
    ...
    initial begin
        $display("\n====================================================");
        $display("  TESTBENCH START: t13_shift_boundary");
        $display("  Instruction ROM: ../hex/t13_shift_boundary.hex");
        $display("====================================================\n");
        ...
        $readmemh("../hex/t13_shift_boundary.hex", U_RISCV.U_IM.memory);
    ...
    always @(posedge clk) begin
        if (!rst) begin
            ...
            if (stable_pc_cycles >= 2 && U_RISCV.out_ins == 32'h0000006f) begin
                $display("\n==================== TEST PASS ====================");
                $display("  Test      : t13_shift_boundary");
